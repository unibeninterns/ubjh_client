...
import { useAuth, withManagerAuth } from "@/contexts/AuthContext";
...
function ManagerLayoutComponent({ children }: ManagerLayoutProps) {
...
export const ManagerLayout = withManagerAuth(ManagerLayoutComponent);
