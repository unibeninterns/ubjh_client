              ...
              if (item.subItems) {
                return (
                  <div key={item.name}>
                    <button
                      className={cn(
                        "flex items-center justify-between w-full space-x-3 px-3 py-2 rounded-lg text-xs font-medium transition-colors",
                        isActive ? "bg-[#35395BD9] text-[#F7DE8E]" : "text-white hover:bg-[#35395BD9]"
                      )}
                    >
                      <div className="flex items-center space-x-3">
                      ...
                      {item.subItems.map((subItem) => {
                        ...
                        return (
                          <Link
                            ...
                            className={cn(
                              "flex items-center space-x-3 px-3 py-2 rounded-lg text-xs font-medium transition-colors",
                              isSubActive ? "bg-[#35395BD9] text-[#F7DE8E]" : "text-white hover:bg-[#35395BD9]"
                            )}
                            onClick={() => setIsMobileMenuOpen(false)}
                          >
