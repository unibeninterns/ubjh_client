  ...
  getAllManuscripts = asyncHandler(
    async (req: Request, res: Response<IManuscriptResponse>): Promise<void> => {
      ...
      if (sort === 'duplicates') {
        ...
        console.log("Manuscripts from backend (duplicates sort):", manuscripts);
      ...
      if (faculty) {
        ...
        console.log("Manuscripts from backend (faculty filter):", manuscripts);
        ...
        console.log("Manuscripts from backend (default case):", manuscripts);
